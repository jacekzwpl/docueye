workspace "DocuEye" "DocuEye Architecture" {
    ...
    model {
        ...
        docueye.app.spa -> docueye.app.issueTracker "Reads data about issues" "HTTPS"

        docueye.app.importer -> docueye.app.changeTracker "Sends events to" "In-process call"
        docueye.app.importer -> docueye.app.modelkeeper "Sends write data commands and reads data" "In-process call"
        docueye.app.importer -> docueye.app.workspacesKeeper "Sends write data commands and reads data" "In-process call"
        docueye.app.importer -> docueye.app.viewsKeeper "Sends write data commands and reads data" "In-process call"
        docueye.app.importer -> docueye.app.docsKeeper "Sends write data commands and reads data" "In-process call"
        docueye.app.importer -> docueye.app.issueTracker "Sends write data commands and reads data" "In-process call"

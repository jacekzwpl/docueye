...
namespace DocuEye.Structurizr.DSL
{
    ...
    {
        public override StructurizrContainerView VisitContainerView([NotNull] StructurizrDSLParser.ContainerViewContext context)
        {
            ...
            var view = new StructurizrContainerView(elementIdentifier, identifier, descritpiton);

            var viewBodyContext = context.containerViewBody();
            if (viewBodyContext != null)
            {
                var viewBody = this.VisitContainerViewBody(viewBodyContext);
        ...
        public override StructurizrContainerView VisitContainerViewBody([NotNull] StructurizrDSLParser.ContainerViewBodyContext context)
        {
            var view = new StructurizrContainerView("", "");

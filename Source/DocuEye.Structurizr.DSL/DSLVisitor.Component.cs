...
namespace DocuEye.Structurizr.DSL
{
    ...
    {
        public StructurizrComponent VisitComponent([NotNull] ComponentContext context, string containerIdentifier)
        {
            string identifier;
            ...
            var element = new StructurizrComponent(identifier, containerIdentifier, new string[] {
                "Element", "Component"
            });
            ...
            if (nameContext == null)
            {
                throw new Exception(
                    string.Format(
                        "Name is required for component at {0}:{1}",
                        context.Start.Line,
            ...
            if (bodyContext != null)
            {
                ...
                /*
                var containerBody = this.VisitComponentBody(bodyContext, element.Identifier);
                ...
                element.Adrs = containerBody.Adrs;
                element.Docs = containerBody.Docs;*/
            }

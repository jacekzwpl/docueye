...
{
    public class ElementStyleToImport
    {
        /// <summary>
        ...
        /// <summary>
        /// The background color of the element, as a HTML RGB hex string (e.g. \'#ffffff\').
        /// </summary>
        public string? Background { get; set; }
        /// <summary>
        /// The stroke color of the element, as a HTML RGB hex string (e.g. \'#000000\').
        /// </summary>
        ...
        /// <summary>
        /// The foreground (text) color of the element, as a HTML RGB hex string (e.g. \'#ffffff\').
        /// </summary>

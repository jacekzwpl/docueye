...
namespace DocuEye.ModelKeeper.Application.Queries.GetAllWorkspaceElements
{
    ...
    /// </summary>
    public class GetAllWorkspaceElementsQueryHandler : IQueryHandler<GetAllWorkspaceElementsQuery, IEnumerable<Element>>
    {
        ...
        public async Task<IEnumerable<Element>> HandleAsync(GetAllWorkspaceElementsQuery request, CancellationToken cancellationToken)
        {

...
namespace DocuEye.ViewsKeeper.Application.Queries.GetContainerView
{
    ...
    /// </summary>
    public class GetContainerViewQueryHandler : IRequestHandler<GetContainerViewQuery, ContainerView?>
    {
        ...
        public async Task<ContainerView?> Handle(GetContainerViewQuery request, CancellationToken cancellationToken)
        {

...
namespace DocuEye.WorkspacesKeeper.Application.Commands.SaveViewConfiguration
{
    ...
    /// </summary>
    public class SaveViewConfigurationCommandHandler : ICommandHandler<SaveViewConfigurationCommand>
    {
        ...
        /// <returns></returns>
        public async Task HandleAsync(SaveViewConfigurationCommand request, CancellationToken cancellationToken)
        {

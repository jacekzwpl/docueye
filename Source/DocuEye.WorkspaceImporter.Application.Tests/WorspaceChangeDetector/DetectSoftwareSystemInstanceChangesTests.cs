...
{
    public class DetectSoftwareSystemInstanceChangesTests : BaseWorkspaceChangeDetectorTests
    {
        [Test]
        ...
        public async Task WhenThereIsNewInstanceThenDetectorReturnsElementToAdd()
        {
            ...
            Assert.That(result.ElementsToAdd?.Where(o => o.DslId == "SI2").Count(), Is.EqualTo(1), "There should be 1 element with dslid = SI2 to add in detector results.");
            Assert.That(result.ElementsToChange?.Count, Is.EqualTo(0), "There should not be any elements to change in detector results.");
            Assert.That(result.ElementsToDelete?.Count, Is.EqualTo(0), "There should not be any elements to delete in detector results.");
        }
        [Test]
        ...
        {
            // Arrange
            this.explodedElements.First(o => o.DslId == "S1")
                .Name = "Name changed";
            ...
            Assert.That(result.ElementsToChange?.Count, Is.EqualTo(2), "There should not be 2 elements to change in detector results.");
            Assert.That(result.ElementsToChange?.Where(o => o.DslId == "SI1").Count(), Is.EqualTo(1), "There should be 1 element with dslid = SI1 to change in detector results.");
            Assert.That(result.ElementsToDelete?.Count, Is.EqualTo(0), "There should not be any elements to delete in detector results.");
        }
        [Test]
        ...
        {
            // Arrange
            this.explodedElements.First(o => o.DslId == "SI1")
                .DslId = "SI1Changed";
            ...
            Assert.That(result.ElementsToAdd?.Where(o => o.DslId == "SI1Changed").Count(), Is.EqualTo(1), "There should be 1 element with dslid = SI1Changed to add in detector results.");
            Assert.That(result.ElementsToDelete?.Where(o => o.DslId == "SI1").Count(), Is.EqualTo(1), "There should be 1 element with dslid = SI1 to delete in detector results.");
        }
        [Test]
        public async Task WhenInstanceHasBeenRemovedThenDetectorReturnsElementToDelete()
        {
            // Arrange
            var item = this.explodedElements.First(o => o.DslId == "SI1");

...
namespace DocuEye.ModelKeeper.Api.Controllers
{
    ...
    public class ElementsController : ControllerBase
    {
        ...
        /// <param name="workspaceId">Workspace Id</param>
        /// <param name="id">Element Id</param>
        /// <param name="type">Type of consumers</param>
        /// <returns></returns>
        [Route("{id}/consumers")]
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ElementConsumer>>> GetElementConsumers([FromRoute] string workspaceId, [FromRoute] string id, [FromQuery] string? type = null)
        {
            var query = new GetElementConsumersQuery(id, workspaceId);

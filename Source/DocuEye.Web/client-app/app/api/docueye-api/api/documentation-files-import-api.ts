...
export const DocumentationFilesImportApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         * @param {string} workspaceId 
         * @param {ImportDocumentationFileRequest} [importDocumentationFileRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiWorkspacesWorkspaceIdDocfilePut: async (workspaceId: string, importDocumentationFileRequest?: ImportDocumentationFileRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('apiWorkspacesWorkspaceIdDocfilePut', 'workspaceId', workspaceId)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(importDocumentationFileRequest, localVarRequestOptions, configuration)
...
export const DocumentationFilesImportApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiWorkspacesWorkspaceIdDocfilePut(workspaceId: string, importDocumentationFileRequest?: ImportDocumentationFileRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiWorkspacesWorkspaceIdDocfilePut(workspaceId, importDocumentationFileRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DocumentationFilesImportApi.apiWorkspacesWorkspaceIdDocfilePut']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const DocumentationFilesImportApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiWorkspacesWorkspaceIdDocfilePut(workspaceId: string, importDocumentationFileRequest?: ImportDocumentationFileRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.apiWorkspacesWorkspaceIdDocfilePut(workspaceId, importDocumentationFileRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DocumentationFilesImportApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public apiWorkspacesWorkspaceIdDocfilePut(workspaceId: string, importDocumentationFileRequest?: ImportDocumentationFileRequest, options?: RawAxiosRequestConfig) {
        return DocumentationFilesImportApiFp(this.configuration).apiWorkspacesWorkspaceIdDocfilePut(workspaceId, importDocumentationFileRequest, options).then((request) => request(this.axios, this.basePath));
    }
}

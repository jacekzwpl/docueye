...
{
    public class StructurizrJsonDeploymentNode
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<StructurizrJsonDeploymentNode>? Children { get; set; }
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<StructurizrJsonContainerInstance>? ContainerInstances { get; set; }
        /// <summary>
        /// The set of software systems instances running in this deployment node..
        /// </summary>
        public IEnumerable<StructurizrJsonSoftwareSystemInstance>? SoftwareSystemInstances { get; set; }
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<StructurizrJsonInfrastructureNode>? InfrastructureNodes { get; set; }

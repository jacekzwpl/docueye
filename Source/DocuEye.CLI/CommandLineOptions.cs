...
namespace DocuEye.CLI
{
    public class CommandLineOptions
    {
        ...
        [Option("adminToken", Required = false, HelpText = "The Admin token from DocuEye configuration.")]
        ...
        [Option("oidcAuthority", Required = false, HelpText = "")]
        public string? OidcAuthority { get; set; }
        [Option("oidcClientId", Required = false, HelpText = "")]

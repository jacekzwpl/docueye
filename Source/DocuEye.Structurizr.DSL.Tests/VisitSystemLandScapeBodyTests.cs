...
{
    public class VisitSystemLandScapeBodyTests : BaseTests
    {
        [Test]
        public void WhenDescriptionIsSetThenCorrectValueIsReturned()
        {
            ...
            ");
            var context = parser.systemLandScapeBody();
            var visitor = new DSLVisitor();

            // Act
            var result = visitor.VisitSystemLandScapeBody(context);
        ...
        public void WhenDuplicateDescriptionIsSetThenExceptionIsThrown()
        {
            ...
            // Act & Assert
            Assert.Throws<Exception>(() => visitor.VisitSystemLandScapeBody(context));
        }

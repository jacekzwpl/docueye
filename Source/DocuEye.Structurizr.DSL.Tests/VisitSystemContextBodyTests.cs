...
{
    public class VisitSystemContextBodyTests : BaseTests
    {
        [Test]
        public void WhenDescriptionIsSetThenCorrectValueIsReturned()
        {
            ...
            ");
            var context = parser.systemContextBody();
            var visitor = new DSLVisitor();

            // Act
            var result = visitor.VisitSystemContextBody(context);
        ...
        public void WhenDuplicateDescriptionIsSetThenExceptionIsThrown()
        {
            ...
            // Act & Assert
            Assert.Throws<Exception>(() => visitor.VisitSystemContextBody(context));
        }

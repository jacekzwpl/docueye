...
{
    public class VisitComponentViewBodyTests : BaseTests
    {
        [Test]
        public void WhenDescriptionIsSetThenCorrectValueIsReturned()
        {
            ...
            ");
            var context = parser.componentViewBody();
            var visitor = new DSLVisitor();

            // Act
            var result = visitor.VisitComponentViewBody(context);
        ...
        public void WhenDuplicateDescriptionIsSetThenExceptionIsThrown()
        {
            ...
            // Act & Assert
            Assert.Throws<Exception>(() => visitor.VisitComponentViewBody(context));
        }

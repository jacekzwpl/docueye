...
{
    public class VisitDeploymentViewBodyTests : BaseTests
    {
        [Test]
        public void WhenDescriptionIsSetThenCorrectValueIsReturned()
        {
            ...
            ");
            var context = parser.deploymentViewBody();
            var visitor = new DSLVisitor();

            // Act
            var result = visitor.VisitDeploymentViewBody(context);
        ...
        public void WhenDuplicateDescriptionIsSetThenExceptionIsThrown()
        {
            ...
            // Act & Assert
            Assert.Throws<Exception>(() => visitor.VisitDeploymentViewBody(context));
        }

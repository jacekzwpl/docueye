...
{
    public class VisitContainerViewBodyTests : BaseTests
    {
        [Test]
        public void WhenDescriptionIsSetThenCorrectValueIsReturned()
        {
            ...
            ");
            var context = parser.containerViewBody();
            var visitor = new DSLVisitor();

            // Act
            var result = visitor.VisitContainerViewBody(context);
        ...
        public void WhenDuplicateDescriptionIsSetThenExceptionIsThrown()
        {
            ...
            // Act & Assert
            Assert.Throws<Exception>(() => visitor.VisitContainerViewBody(context));
        }

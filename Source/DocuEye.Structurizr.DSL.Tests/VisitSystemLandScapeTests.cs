...
{
    public class VisitSystemLandScapeTests : BaseTests
    {
        [Test]
        public void WhenDefineSystemLandscapeThenAllPropertiesAreSet()
        {
            // Arrange
            var parser = CreateParserFromText(@"systemLandscape viewId ""view description"" 
            {
            ...
            var context = parser.systemLandScape();
            var visitor = new DSLVisitor();
            // Act
            var result = visitor.VisitSystemLandScape(context);
            // Assert

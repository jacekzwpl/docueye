...
namespace DocuEye.Structurizr.DSL.Model
{
    public class StructurizrContainer
    {
        ...
        public StructurizrContainer(string identifier, string systemIdentifier)
        {
        ...
        public StructurizrContainer(string identifier, string systemIdentifier, string[] tags)
        {
            Identifier = identifier;

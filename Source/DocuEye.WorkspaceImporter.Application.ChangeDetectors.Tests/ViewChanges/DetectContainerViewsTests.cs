...
{
    public class DetectContainerViewsTests : BaseDetectorsTests
    {
        [Test]
        public void WhenContainerViewIsDefindedThenAllPropertiesAreMatched()
        {
            // Arrange
            ...
            // Act
            var result = detector.DetectContainerViews(
                "workspaceId",
                viewsToImport,
                viewsIdsMap,
                existingElements,
            ...
            Assert.That(result.First().ExternalSoftwareSystemBoundariesVisible, Is.True);

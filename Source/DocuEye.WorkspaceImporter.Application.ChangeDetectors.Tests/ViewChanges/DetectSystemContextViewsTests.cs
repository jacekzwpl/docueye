...
{
    public class DetectSystemContextViewsTests : BaseDetectorsTests
    {
        [Test]
        public void WhenSystemContextViewIsDefindedThenAllPropertiesAreMatched()
        {
            // Arrange
            ...
            // Act
            var result = detector.DetectSystemContextViews(
                "workspaceId",
                viewsToImport,
                viewsIdsMap,
                existingElements,
